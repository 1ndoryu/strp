        ...
        switch (etapaActual.id) {
            ...
            case 'etapa-plan':
             ...
             case 'etapa-perfil':
                 ...
                 if (!validarCampo(descripcionTextarea, '#error-descripcion', descVal && descVal.length >= 30 && descVal.length <= 500, `La descripción es obligatoria (entre 30 y 500 caracteres). Actual: ${descVal.length}`)) { esValido = false; inputsInvalidos.push(descripcionTextarea); }
