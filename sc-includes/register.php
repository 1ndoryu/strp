...
<div class="col_rgt"><input name="name_register" type="text" id="name_register" size="150" maxlength="150" /><div class="error_msg" id="error_name"><?=$language['register.error_name']?></div>
