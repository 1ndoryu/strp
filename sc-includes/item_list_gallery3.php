...
<? if($ad['ad']['renovable'] == renovationType::Autorenueva){?>
...
<div class="imageAdMin <?= getImgOrientation($ad['images'][0]['name_image']); ?>">
	...
	<a href="<?=URL($ad);?>" onclick="event.preventDefault();">
		<img loading="lazy" itemprop="image" src='<?=Images::getImage($ad['images'][0]['name_image'], IMG_ADS, false,  $ad['images'][0]['edit']);?>' alt='<?=stripslashes($ad['ad']['title']); ?>'/>
	</a>
	<?php if(isset($FAVORITES_ADS)): ?>
		<span class="delete_fav" onclick="delFav('<?=$ad['ad']['ID_ad']?>')">
